...
const Family = () => {
  ...
  const videos = [
    ...
    { uri: 'https://www.signingsavvy.com/media2/mp4-ld/26/26715.mp4', name: 'BROTHER' },
  ...
  const handleVideoCompletion = () => {
    const videoName = `family_${videos[currentVideoIndex].name}`; // Prefix with section identifier
